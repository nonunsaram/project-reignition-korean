...
public partial class PauseMenu : Node
{
	...
	public override void _Ready()
	{
		...
		ModManager.Instance?.ApplyLocalizationFont(areaLabel);
		...
		if (TimeAttackManager.Instance.IsRunActive && TimeAttackManager.Instance.CurrentRunType != TimeAttackManager.RunType.SingleRun)
		{
			...
			ModManager.Instance?.ApplyLocalizationFont(restart);
			ModManager.Instance?.ApplyLocalizationFont(glow);
	...
	private void UpdateStatusMenuData()
	{
		...
		ModManager.Instance?.ApplyLocalizationFont(missionTypeLabel);
