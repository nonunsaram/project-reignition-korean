...
public partial class LevelOption : Control
{
	...
	private void ApplySettings()
	{
		...
		if (missionLabel != null)
		{
			...
			ModManager.Instance?.ApplyLocalizationFont(missionLabel);
		}
	...
	public void EnableTAInfo()
	{
		...
		ModManager.Instance?.ApplyLocalizationFont(missionLabelTA);
		ModManager.Instance?.ApplyLocalizationFont(areaLabelTA);
	}
}
