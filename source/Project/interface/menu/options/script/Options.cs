...
public partial class Options : Menu
{
	...
	private void UpdateLabels()
	{
		...
		languageLabels[0].Text = GetLanguageKey(SaveManager.Config.textLocale);
		languageLabels[1].Text = GetLanguageKey(SaveManager.Config.voiceLocale);
	...
	private string GetLanguageKey(LocalizationResource language)
	{
		string localeId = language.LocaleId == "pt" ? "pt_BR" : language.LocaleId;
		return $"lang_{localeId}";
	}
