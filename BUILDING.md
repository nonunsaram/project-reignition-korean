...
1. Check out Project Reignition commit `2d45af71b` (`Hotfix v1.0.1`) and apply the files under `source/Project/` to the matching paths.
...
The shipped release ZIP is the supported end-user artifact. Always test installation and removal against an untouched Windows v1.0.1 game before publishing a new tag.
